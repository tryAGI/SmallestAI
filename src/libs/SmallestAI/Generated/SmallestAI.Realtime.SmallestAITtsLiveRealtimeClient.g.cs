...
{
    /// <summary>
    /// Lightning realtime text-to-speech. The same URL serves SSE over HTTP<br/>
    /// `POST`; connecting with `wss://` selects the WebSocket protocol instead.<br/>
    /// Send one JSON request per synthesis. Audio arrives as base64 `chunk`<br/>
    /// frames, optionally interleaved with `word_timestamp` frames (English and<br/>
    /// Hindi voices only), terminated by a `complete` frame. Within a<br/>
    /// `context_id` continuation, `complete` ends one segment and the socket<br/>
    /// stays open for the next.
    /// </summary>
    public sealed partial class SmallestAITtsLiveRealtimeClient : global::System.IDisposable, global::System.IAsyncDisposable
    {
        /// <summary>
        /// Default WebSocket base URL.
        /// </summary>
        public const string DefaultBaseUrl = "wss://api.smallest.ai/waves/v1/tts/live";
        ...
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::SmallestAI.Realtime.TtsLiveEvent>>? MessageReceived;
        /// <summary>
        /// Raised after a TtsEvent message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::SmallestAI.Realtime.TtsLiveEvent>>? TtsEventReceived;
        ...
        /// <summary>
        /// Creates a new instance of the SmallestAITtsLiveRealtimeClient.
        ...
        public SmallestAITtsLiveRealtimeClient(
        ...
        private const string DefaultBaseUrlTemplate = "wss://api.smallest.ai/waves/v1/tts/live";


        /// <summary>
        /// Connects to the WebSocket server with typed connection parameters.
        /// </summary>
        /// <param name="timeout">Idle connection timeout in seconds before the server closes the socket.</param>
