...
namespace SmallestAI
{
    public partial class SubpackagePronunciationDictionariesClient
    {
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement s_UpdatePronunciationDictSecurityRequirement0 =
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement[] s_UpdatePronunciationDictSecurityRequirements =
            new global::SmallestAI.EndPointSecurityRequirement[]
            {                s_UpdatePronunciationDictSecurityRequirement0,
            };
        partial void PrepareUpdatePronunciationDictArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::SmallestAI.UpdatePronunciationDictRequest request);
        partial void PrepareUpdatePronunciationDictRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::SmallestAI.UpdatePronunciationDictRequest request);
        partial void ProcessUpdatePronunciationDictResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdatePronunciationDictResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.UpdatePronunciationDictResponse> UpdatePronunciationDictAsync(

            global::SmallestAI.UpdatePronunciationDictRequest request,
            global::SmallestAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UpdatePronunciationDictAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SmallestAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.UpdatePronunciationDictResponse>> UpdatePronunciationDictAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdatePronunciationDictArguments(
            ...
            var __authorizations = global::SmallestAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdatePronunciationDictSecurityRequirements,
                operationName: "UpdatePronunciationDictAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdatePronunciationDictRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SmallestAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdatePronunciationDictAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdatePronunciationDictResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdatePronunciationDictResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SmallestAI.UpdatePronunciationDictResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.UpdatePronunciationDictResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SmallestAI.UpdatePronunciationDictResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.UpdatePronunciationDictResponse> UpdatePronunciationDictAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::SmallestAI.UpdatePronunciationDictRequest
            {
                Id = id,
                Items = items,
            };

            return await UpdatePronunciationDictAsync(
                request: __request,
                requestOptions: requestOptions,
