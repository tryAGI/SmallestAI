...
namespace SmallestAI
{
    public partial class SpeechToTextClient
    {
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement s_TranscribeWithJsonSecurityRequirement0 =
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement[] s_TranscribeWithJsonSecurityRequirements =
            new global::SmallestAI.EndPointSecurityRequirement[]
            {                s_TranscribeWithJsonSecurityRequirement0,
            };
        ...
        partial void PrepareTranscribeWithJsonRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::SmallestAI.TranscriptionUrlRequest request);
        partial void ProcessTranscribeWithJsonResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTranscribeWithJsonResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTranscribeWithJsonArguments(
            ...
            var __authorizations = global::SmallestAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TranscribeWithJsonSecurityRequirements,
                operationName: "TranscribeWithJsonAsync");
            ...
            if (xExpireContent != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTranscribeWithJsonRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SmallestAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TranscribeWithJson",
                                methodName: "TranscribeWithJsonAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTranscribeWithJsonResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTranscribeWithJsonResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.SpeechToTextTranscribeResponse200> TranscribeWithJsonAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::SmallestAI.TranscriptionUrlRequest
            {
                Url = url,
            };

            return await TranscribeWithJsonAsync(
                model: model,
                language: language,
                wordTimestamps: wordTimestamps,
                diarize: diarize,
