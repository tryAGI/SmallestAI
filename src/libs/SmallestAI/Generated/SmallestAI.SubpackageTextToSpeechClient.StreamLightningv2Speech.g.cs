...
namespace SmallestAI
{
    public partial class SubpackageTextToSpeechClient
    {
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement s_StreamLightningv2SpeechSecurityRequirement0 =
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement[] s_StreamLightningv2SpeechSecurityRequirements =
            new global::SmallestAI.EndPointSecurityRequirement[]
            {                s_StreamLightningv2SpeechSecurityRequirement0,
            };
        partial void PrepareStreamLightningv2SpeechArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::SmallestAI.Lightningv2Request request);
        partial void PrepareStreamLightningv2SpeechRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::SmallestAI.Lightningv2Request request);
        partial void ProcessStreamLightningv2SpeechResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStreamLightningv2SpeechResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> StreamLightningv2SpeechAsync(

            global::SmallestAI.Lightningv2Request request,
            global::SmallestAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await StreamLightningv2SpeechAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SmallestAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SmallestAI.AutoSDKHttpResponse<string>> StreamLightningv2SpeechAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStreamLightningv2SpeechArguments(
            ...
            var __authorizations = global::SmallestAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StreamLightningv2SpeechSecurityRequirements,
                operationName: "StreamLightningv2SpeechAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::SmallestAI.PathBuilder(
                                path: "/waves/v1/lightning-v2/stream",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareStreamLightningv2SpeechRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SmallestAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "StreamLightningv2SpeechAsync",
                                pathTemplate: "\"/waves/v1/lightning-v2/stream\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStreamLightningv2SpeechResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::SmallestAI.StreamLightningv2SpeechRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::SmallestAI.StreamLightningv2SpeechRequestBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::SmallestAI.ApiException<global::SmallestAI.StreamLightningv2SpeechRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::SmallestAI.StreamLightningv2SpeechRequestUnauthorizedError? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::SmallestAI.StreamLightningv2SpeechRequestUnauthorizedError.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::SmallestAI.ApiException<global::SmallestAI.StreamLightningv2SpeechRequestUnauthorizedError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::SmallestAI.StreamLightningv2SpeechRequestInternalServerError? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::SmallestAI.StreamLightningv2SpeechRequestInternalServerError.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::SmallestAI.ApiException<global::SmallestAI.StreamLightningv2SpeechRequestInternalServerError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStreamLightningv2SpeechResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await StreamLightningv2SpeechAsync(
                request: __request,
                requestOptions: requestOptions,
