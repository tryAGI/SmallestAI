                ...
                else
                {
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::SmallestAI.ApiException<global::SmallestAI.CreateVoiceCloneRequestBadRequestError>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::SmallestAI.ApiException<global::SmallestAI.CreateVoiceCloneRequestUnauthorizedError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::SmallestAI.ApiException<global::SmallestAI.CreateVoiceCloneRequestInternalServerError>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SmallestAI.VoiceCloningCreateVoiceCloneResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.VoiceCloningCreateVoiceCloneResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SmallestAI.VoiceCloningCreateVoiceCloneResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
