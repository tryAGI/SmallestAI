...
namespace SmallestAI
{
    public partial class SubpackagePronunciationDictionariesClient
    {
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement s_CreatePronunciationDictSecurityRequirement0 =
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement[] s_CreatePronunciationDictSecurityRequirements =
            new global::SmallestAI.EndPointSecurityRequirement[]
            {                s_CreatePronunciationDictSecurityRequirement0,
            };
        partial void PrepareCreatePronunciationDictArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::SmallestAI.CreatePronunciationDictRequest request);
        partial void PrepareCreatePronunciationDictRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::SmallestAI.CreatePronunciationDictRequest request);
        partial void ProcessCreatePronunciationDictResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePronunciationDictResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.PronunciationDict> CreatePronunciationDictAsync(

            global::SmallestAI.CreatePronunciationDictRequest request,
            global::SmallestAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreatePronunciationDictAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SmallestAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.PronunciationDict>> CreatePronunciationDictAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePronunciationDictArguments(
            ...
            var __authorizations = global::SmallestAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePronunciationDictSecurityRequirements,
                operationName: "CreatePronunciationDictAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePronunciationDictRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SmallestAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreatePronunciationDictAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePronunciationDictResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePronunciationDictResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SmallestAI.PronunciationDict.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.PronunciationDict>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SmallestAI.PronunciationDict.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.PronunciationDict> CreatePronunciationDictAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::SmallestAI.CreatePronunciationDictRequest
            {
                Items = items,
            };

            return await CreatePronunciationDictAsync(
                request: __request,
                requestOptions: requestOptions,
