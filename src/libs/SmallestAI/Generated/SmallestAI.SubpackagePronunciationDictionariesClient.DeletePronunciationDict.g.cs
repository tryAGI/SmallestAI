...
namespace SmallestAI
{
    public partial class SubpackagePronunciationDictionariesClient
    {
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement s_DeletePronunciationDictSecurityRequirement0 =
        ...
        private static readonly global::SmallestAI.EndPointSecurityRequirement[] s_DeletePronunciationDictSecurityRequirements =
            new global::SmallestAI.EndPointSecurityRequirement[]
            {                s_DeletePronunciationDictSecurityRequirement0,
            };
        partial void PrepareDeletePronunciationDictArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::SmallestAI.DeletePronunciationDictRequest request);
        partial void PrepareDeletePronunciationDictRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::SmallestAI.DeletePronunciationDictRequest request);
        partial void ProcessDeletePronunciationDictResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeletePronunciationDictResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.DeletePronunciationDictResponse> DeletePronunciationDictAsync(

            global::SmallestAI.DeletePronunciationDictRequest request,
            global::SmallestAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeletePronunciationDictAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SmallestAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.DeletePronunciationDictResponse>> DeletePronunciationDictAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDeletePronunciationDictArguments(
            ...
            var __authorizations = global::SmallestAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeletePronunciationDictSecurityRequirements,
                operationName: "DeletePronunciationDictAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeletePronunciationDictRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SmallestAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeletePronunciationDictAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeletePronunciationDictResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SmallestAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeletePronunciationDictResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SmallestAI.DeletePronunciationDictResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SmallestAI.AutoSDKHttpResponse<global::SmallestAI.DeletePronunciationDictResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SmallestAI.DeletePronunciationDictResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::SmallestAI.DeletePronunciationDictResponse> DeletePronunciationDictAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::SmallestAI.DeletePronunciationDictRequest
            {
                Id = id,
            };

            return await DeletePronunciationDictAsync(
                request: __request,
                requestOptions: requestOptions,
