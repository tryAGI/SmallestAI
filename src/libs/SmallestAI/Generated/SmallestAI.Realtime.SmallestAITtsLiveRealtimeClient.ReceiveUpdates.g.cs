...
namespace SmallestAI.Realtime
{
    public sealed partial class SmallestAITtsLiveRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::SmallestAI.Realtime.TtsLiveEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::SmallestAI.Realtime.TtsLiveEvent @event;
                    try
                    {
                        @event = (global::SmallestAI.Realtime.TtsLiveEvent?)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::SmallestAI.Realtime.TtsLiveEvent), JsonSerializerContext) ??
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::SmallestAI.Realtime.TtsLiveEvent>(
                    @event,
                    rawText,
                    json));

            TtsEventReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::SmallestAI.Realtime.TtsLiveEvent>(
                    @event,
                    rawText,
