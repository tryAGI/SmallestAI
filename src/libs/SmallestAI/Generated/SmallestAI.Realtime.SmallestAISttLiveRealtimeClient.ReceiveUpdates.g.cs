...
namespace SmallestAI.Realtime
{
    public sealed partial class SmallestAISttLiveRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::SmallestAI.Realtime.SttTranscriptionEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::SmallestAI.Realtime.SttTranscriptionEvent @event;
                    try
                    {
                        @event = (global::SmallestAI.Realtime.SttTranscriptionEvent?)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::SmallestAI.Realtime.SttTranscriptionEvent), JsonSerializerContext) ??
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::SmallestAI.Realtime.SttTranscriptionEvent>(
                    @event,
                    rawText,
                    json));
